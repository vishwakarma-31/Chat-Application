...
const Sidebar: React.FC = () => {
  ...
  const { activeConversationId, conversations, setCurrentUser } = useChatStore();
        ...
        {conversationsWithPreviews.map(conversation => (
          <div 
            ...
            className={`p-4 border-b border-gray-100 cursor-pointer hover:bg-gray-50 transition-all duration-200 ${
              activeConversationId === conversation.conversationId ? 'bg-blue-50 border-l-4 border-l-blue-500' : ''
            }`}
          >
