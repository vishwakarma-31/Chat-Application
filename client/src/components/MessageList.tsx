                  ...
                  >
                    ...
                    <div className={`text-[10px] mt-1 flex items-center ${isSelf ? 'text-indigo-200 justify-end' : 'text-slate-400'}`}>
                      ...
                      {isSelf && (
                        <span className="ml-1">
                          {message.status === 'Read' ? (
                            <svg className="w-4 h-4 text-blue-300" fill="currentColor" viewBox="0 0 20 20"><path d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z"/></svg>
                          ) : (
                            <svg className="w-4 h-4 text-indigo-300" fill="currentColor" viewBox="0 0 20 20"><path d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z"/></svg>
                          )}
                        </span>
                      )}
                    </div>
